...
<html lang="en">
  ...
  <body>
    ...
    <div class="Dashboard">
      ...
      <div class="dash-menu">
        <div class="left-dash">
          <img class="logo" src="img/Itum logo.png" alt="" />
        ...
        <div class="right-dash">
          ...
          <h4>Admin</h4>
          <img class="admin-avatar" src="img/User.jpg" alt="" />
        </div>
      </div>
        ...
        <div class="navbar">
          ...
          <div class="slide-bar">
            ...
            <div class="box1">
              ...
              <a href="inbound.php">
                <div id="active" class="inbound">
                  <img src="img/arrow-up-dark.png" alt="" />
                  <img class="light" src="img/arrow-up-light.png" alt="" />
            ...
            <div class="box1">
              ...
              <a href="outbound.php">
                <div class="outbound">
                  <img class="light" src="img/arrow-down-light.png" alt="" />
                  <p>Outbound</p>
                </div>
              </a>
            </div>
            ...
            <div class="box1">
              ...
              <a href="Report.html">
                <div class="report">
                  <img class="light" src="img/report-light.png" alt="" />
                  <p>Report</p>
                </div>
              </a>
            </div>
            ...
            <div class="box1">
              ...
              <a href="History.html">
                <div class="history">
                  <img class="light" src="img/history-light.png" alt="" />
                  <p>History</p>
                </div>
              </a>
            </div>
            ...
            <div class="container">
              ...
              <form id="inbound_form" name="inbound_form">
                <div class="row col-md-12 col-lg-12 col-sm-12">
                  <span class="col-md-9 col-lg-9 col-sm-9 px-4"
                    >PO.NO: <input type="text" name="po_no" id="po_no"
                  /></span>
                  <span class="col-md-3 col-lg-3 col-sm-3"
                    >GRN: <input type="text" name="grn_no" id="grn_no"
                  /></span>
                </div>
                ...
                <div id="first5" name="first5">
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <!-- ID is hidden -->
                    <span
                      class="col-md-2 col-lg-2 col-sm-2 text-center"
                      style="display: none"
                    >
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock"
                        id="stock"
                        onkeyup="totalAmount('stock','unit','tstock')"
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock2"
                        id="stock2"
                        onkeyup="totalAmount('stock2','unit2','tstock2')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock3"
                        id="stock3"
                        onkeyup="totalAmount('stock3','unit3','tstock3')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock4"
                        id="stock4"
                        onkeyup="totalAmount('stock4','unit4','tstock4')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock5"
                        id="stock5"
                        onkeyup="totalAmount('stock5','unit5','tstock5')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                ...
                <div id="add10" style="text-align: right">
                  <input
                    type="button"
                    class="admin-avatar btn-ld text-white btn-outline-warning border-0"
                    onclick="add10()"
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock6"
                        id="stock6"
                        onkeyup="totalAmount('stock6','unit6','tstock6')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock7"
                        id="stock7"
                        onkeyup="totalAmount('stock7','unit7','tstock7')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock8"
                        id="stock8"
                        onkeyup="totalAmount('stock8','unit8','tstock8')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock9"
                        id="stock9"
                        onkeyup="totalAmount('stock9','unit9','tstock9')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock10"
                        id="stock10"
                        onkeyup="totalAmount('stock10','unit10','tstock10')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock11"
                        id="stock11"
                        onkeyup="totalAmount('stock11','unit11','tstock11')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock12"
                        id="stock12"
                        onkeyup="totalAmount('stock12','unit12','tstock12')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock13"
                        id="stock13"
                        onkeyup="totalAmount('stock13','unit13','tstock13')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock14"
                        id="stock14"
                        onkeyup="totalAmount('stock14','unit14','tstock14')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                  ...
                  <div class="row col-md-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                        ...
                        name="stock15"
                        id="stock15"
                        onkeyup="totalAmount('stock15','unit15','tstock15')"
                        placeholder="Enter amount of  stock"
                    /></span>
                    <span class="col-md-2 col-lg-2 col-sm-2 text-center"
                      ><input
                ...
                <div class="text-center py-2">
                  <input
                    type="submit"
                    class="btn btn-md btn-ld btn-outline-warning text-white"
                    value="SAVE"
                  />
                </div>
              </form>
      ...
      <div class="footer">
        ...
        <div class="copyright">
          <p>
            Copyrights <img src="img/copyright.png" alt="" />
